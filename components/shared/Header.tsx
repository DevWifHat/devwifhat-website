    ...
    <section className="w-full md:w-1/3 my-4">
      ...
      <div className="mt-4 w-full px-4 flex flex-row items-center justify-between gap-2">
        ...
        <button className='w-1/2 p-2 rounded-[8px] bg-white bg-opacity-0 hover:bg-opacity-10 border border-white border-opacity-50 font-black'>
          <a href="https://app.realms.today/dao/HrTHPmgZ5i9e4zEfDD9KTwscAor7nixUh1uhiDsCds5V" target='_blank' className='bg-black w-full'>DAO</a>
        </button>
      </div>
      ...
      <div className='w-full px-4 mt-4'>
        <div className="w-full flex flex-col justify-center  items-center gap-4 space-x-4 mt-5">
          <button className="btn font-bold border border-white text-white  rounded p-3 bg-white bg-opacity-0 hover:bg-opacity-10 px-6 underline w-full">
            <Link href='/hatpaper' className='flex flex-row items-center justify-center gap-2'>
              Hatpaper
