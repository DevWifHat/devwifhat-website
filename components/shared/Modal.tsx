        ...
        <div className="w-full flex flex-col items-start justify-start gap-2 mb-4 bg-slate-900">
              <div
                ...
                {/* <button
                  ...
                  data-twe-ripple-init
                  data-twe-ripple-color="light">
                    <div className="inline-flex item-start justify-center"><span>Custom</span><input
                type="number"
                className="w-full input focus:border focus:border-white py-2 px-6 mb-2 bg-black"
                min="1"
                max="10"
