...
const NewChart = () => {
  ...
  return (
    <section className='w-full relative border-b border-b-white border-opacity-50'>
      ...
      <div className="border border-white border-opacity-50 p-4 md:-mt-8 rounded-xl bg-black">
        <div className="my-4 w-full max-w-2xl mx-auto flex flex-col items-start justify-start gap-2 mb-8  px-4">
        ...
        <div className="w-full flex max-w-2xl mx-auto flex-col items-center justify-start gap-4 my-4 relative z-10 text-opacity-60 mt-0  pb-8">
          ...
          <div className="w-full flex flex-row items-center justify-between px-4">
            <div className="flex flex-row items-center justify-center gap-2">
              ...
              <a href={`https://solscan.io/account/${ecosystemGrants}`} target='_blank' className='flex flex-row items-center justify-center gap-1 text-xs  hover:opacity-80'>
                Ecosystem Grants
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-4 h-4">
                  <path strokeLinecap="round" strokeLinejoin="round" d="M13.5 6H5.25A2.25 2.25 0 0 0 3 8.25v10.5A2.25 2.25 0 0 0 5.25 21h10.5A2.25 2.25 0 0 0 18 18.75V10.5m-10.5 6L21 3m0 0h-5.25M21 3v5.25" />
                </svg>
          ...
          <div className="w-full flex flex-row items-center justify-between px-4">
            <div className="flex flex-row items-center justify-center gap-2">
              ...
              <a href={`https://solscan.io/account/${founders}`} target='_blank' className='flex flex-row items-center justify-center gap-1 text-xs  hover:opacity-80'>
                Founders Vesting
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-4 h-4">
                  <path strokeLinecap="round" strokeLinejoin="round" d="M13.5 6H5.25A2.25 2.25 0 0 0 3 8.25v10.5A2.25 2.25 0 0 0 5.25 21h10.5A2.25 2.25 0 0 0 18 18.75V10.5m-10.5 6L21 3m0 0h-5.25M21 3v5.25" />
                </svg>
          ...
          <div className="w-full flex flex-row items-center justify-between px-4">
            <div className="flex flex-row items-center justify-center gap-2">
              ...
              <a href={`https://solscan.io/account/${marketing}`} target='_blank' className='flex flex-row items-center justify-center gap-1 text-xs  hover:opacity-80'>
                Marketing & Operations
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-4 h-4">
                  <path strokeLinecap="round" strokeLinejoin="round" d="M13.5 6H5.25A2.25 2.25 0 0 0 3 8.25v10.5A2.25 2.25 0 0 0 5.25 21h10.5A2.25 2.25 0 0 0 18 18.75V10.5m-10.5 6L21 3m0 0h-5.25M21 3v5.25" />
                </svg>
          ...
          <div className="w-full flex flex-row items-center justify-between px-4">
            <div className="flex flex-row items-center justify-center gap-2">
              ...
              <a href={`https://solscan.io/account/${airdrops}`} target='_blank' className='flex flex-row items-center justify-center gap-1 text-xs  hover:opacity-80'>
                Airdrops
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-4 h-4">
                  <path strokeLinecap="round" strokeLinejoin="round" d="M13.5 6H5.25A2.25 2.25 0 0 0 3 8.25v10.5A2.25 2.25 0 0 0 5.25 21h10.5A2.25 2.25 0 0 0 18 18.75V10.5m-10.5 6L21 3m0 0h-5.25M21 3v5.25" />
                </svg>
